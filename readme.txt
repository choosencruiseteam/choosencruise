...
************************** File Structure ********************************
---------------
Why restructure project? For easier navigation of project files, and a flatter
folder hierarchy.
-Chris
---------------
...
javascript - (Hold all javascript files)

PHP - (Hold PHP files)
    -API: Hold PHP files that will be interfaced via a GET request
    -Controllers: Hold PHP Files that will implement classes and methods
                    used in API files.
